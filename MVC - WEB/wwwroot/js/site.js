...
$(document).ready(function () {
    ...
    $('#sidebarCollapse, #sidebarCollapseHeader').on('click', function () {
    ...
    if (window.location.pathname === '/' || window.location.pathname === '/Dashboard' || window.location.pathname === '/Dashboard/Index') {
        initializeDashboard();
    }
